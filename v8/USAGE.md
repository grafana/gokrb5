...
relevant method:
```go
import "github.com/grafana/gokrb5/v8/config"
...
```go
import 	"github.com/grafana/gokrb5/v8/keytab"
...
```go
import 	"github.com/grafana/gokrb5/v8/client"
...
```go
import 	"github.com/grafana/gokrb5/v8/service"
